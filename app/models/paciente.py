...
class Paciente(Base):
    ...
    doctor_cabecera_id  = Column(UUID(as_uuid=True), ForeignKey("doctores.id"), nullable=True)  # ← nuevo
    ...
    _alergias           = Column("alergias", Text)          # Almacenado cifrado
    _notas_generales    = Column("notas_generales", Text)   # Almacenado cifrado
    ...
    # ── PROPIEDADES CON CIFRADO TRANSPARENTE ─────────────────
    @property
